...
const PROMPT = __ENV.PROMPT || 'Explain why batching improves GPU utilization.';

export const options = {
  stages: [
    { duration: '1m', target: Number(__ENV.START_VUS || 40) },
    { duration: '2m', target: Number(__ENV.PEAK_VUS || 200) },
    { duration: '3m', target: Number(__ENV.PEAK_VUS || 200) },
    { duration: '2m', target: Number(__ENV.END_VUS || 40) },
  ],
  thresholds: {
